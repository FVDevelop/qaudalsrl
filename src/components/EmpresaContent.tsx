...
const EmpresaContent = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 bg-gradient-to-b from-background to-muted/20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
            ...
            <div className="order-1 lg:order-2 space-y-4">
              ...
              <p className="text-lg font-light leading-relaxed" style={{ color: "#003249" }}>
                En un mundo donde la eficiencia y la sostenibilidad son esenciales, la experiencia debe complementarse
                con una visión de futuro.
              </p>

              <p className="text-lg font-light leading-relaxed" style={{ color: "#737373" }}>
                En <strong>Qaudal</strong>, integramos el conocimiento técnico de la ingeniería y la arquitectura con la
                innovación de las tecnologías inteligentes.
              </p>

              <p className="text-lg font-light leading-relaxed" style={{ color: "#737373" }}>
                Combinamos Big Data, inteligencia artificial y aprendizaje automático para ofrecer soluciones precisas
                que aborden desafíos complejos y generen un impacto real.
              </p>

              <p className="text-lg font-light leading-relaxed" style={{ color: "#003249" }}>
                Nos especializamos en el <strong>flujo de la vida:</strong> agua, saneamiento, energías renovables y
                protección del medio ambiente.
              </p>

              <p className="text-lg font-light leading-relaxed" style={{ color: "#737373" }}>
                Abarcamos todo el ciclo de vida de un proyecto —desde estudios y diagnósticos hasta diseños conceptuales
                y proyectos ejecutivos—, trabajando con equipos propios y especialistas asociados, tanto en{" "}
                <strong>Argentina</strong> como en el <strong>exterior</strong>.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <p
              className="text-sm md:text-xl font-garet font-semibold uppercase tracking-wider"
              style={{ color: "#007EA7" }}
            >
      ...
      <section
        id="como-trabajamos"
        className="relative py-12 bg-gradient-to-r from-[#003249]/95 via-[#007EA7]/85 to-[#003249]/95 overflow-hidden scroll-mt-28 md:scroll-mt-32"
      >
      ...
      <div className="container mx-auto px-4 pt-5 pb-5">
        <div className="text-center">
          <p className="text-xl max-w-5xl mx-auto font-light leading-relaxed" style={{ color: "#737373" }}>
            En <strong>Qaudal</strong> aplicamos una metodología integral que nos permite abordar cada proyecto desde
            una perspectiva 360°. Nuestro enfoque combina experiencia técnica multidisciplinaria con las mejores
            prácticas de la industria, garantizando soluciones eficientes y sostenibles.
          </p>
        </div>
      </div>
